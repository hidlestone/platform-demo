package com.fallframework.platform.test.starters.webservice.control;

import com.fallframework.platform.test.starters.webservice.service.ServerServiceDemo;
...
public class TestControl {
	...
	public static void invokeService_1() {
		// 接口地址
		String address = "http://localhost:6060/webservice/ws/api?wsdl";
		// 代理工厂
	...
	public static void invokeService_2() {
		...
		Client client = dcf.createClient("http://localhost:6060/webservice/ws/api?wsdl");
		// 需要密码的情况需要加上用户名和密码
